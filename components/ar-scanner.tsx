      ...
      try {
        ...
        if (containerRef.current && MINDAR) {
          mindarThree = new MINDAR.IMAGE.MindARThree({
            ...
            // Thêm các cấu hình ưu tiên camera sau
            uiLoading: "no",
            uiScanning: "no",
          })
          ...
          // ⚠️ FIX MÀN HÌNH ĐEN: Ép kiểu CSS cho thẻ Video do MindAR tạo ra
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 p-4 backdrop-blur-md">
      <div className="relative flex h-full max-h-[85vh] w-full max-w-lg flex-col overflow-hidden rounded-3xl border border-white/20 bg-slate-950 shadow-2xl">
        ...
        <div className="flex items-center justify-between gap-4 bg-slate-900 p-5 border-t border-slate-800 z-20">
